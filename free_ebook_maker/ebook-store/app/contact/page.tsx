import { BookOpen, ShoppingCart, Menu, Mail, MapPin, Phone, Send } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Whether you have questions about our books, need technical support, or want to explore partnership opportunities, we're here to help.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <ContactInfo 
                ...
                title="Email"
                content="xingfang.wang@gmail.com"
            ...
            <div className="p-6 rounded-xl bg-gradient-to-br from-primary/10 to-muted">
          ...
          {/* Contact Form */}
          <div className="p-8 rounded-2xl border border-border/20 bg-white/50 backdrop-blur-sm">
            ...
            <form className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3 text-base font-semibold text-white hover:bg-blue-700 transition-colors"
              >
...
function ContactInfo({ icon, title, content, href }: { icon: React.ReactNode; title: string; content: string; href?: string }) {
  ...
  return (
    <Wrapper 
      href={href}
      className={`flex items-start gap-4 ${href ? 'hover:text-primary transition-colors' : ''}`}
    >
