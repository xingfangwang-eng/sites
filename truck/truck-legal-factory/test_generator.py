...
{text_part1}"""
            ...
            if '|' not in text:
                ...
                try:
                    ...
                    if "Legal Framework & Statutes" in text:
                        # Split the text at the Legal Statutes section
                        parts = text.split("Legal Framework & Statutes")
                        if len(parts) > 1:
                            # Insert the table after the Legal Statutes section with H2 title
                            text = parts[0] + "Legal Framework & Statutes" + parts[1].split("Punitive Damages Analysis")[0] + "\n### Estimated Compensation Comparison: 2024 Industry Data\n\n" + append_text + "\n\nPunitive Damages Analysis" + parts[1].split("Punitive Damages Analysis")[1]
                        else:
...
def main():
    ...
    if rows:
        ...
        try:
            ...
            print(f"文章《{title}》已生成并{table_status}")
